...
<head>
    ...
    <title>Web Site Transfers</title>
</head>
<body>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            ...
            <form action="{{ route('registerUser') }}" method="POST">
                ...
                <input type="password" placeholder=" Password Confirm" name="passwordc"/>
                <button class="btn-grad">Sign Up</button>
            </form>
        </div>
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    ...
                    <p>
                        this web site is supported by Midad
                    </p>
                    <div class="btn-grad" id="signIn">Sign In</div>
                </div>
                <div class="overlay-panel overlay-right">
                    <h1>Hello, friend!</h1>
                    <p>this web site is supported by Midad </p>
